...
public class DozentController {
	...
	public Dozent updateDozent(@PathVariable int aID, @RequestBody Dozent aDozent) {
	 ...
	 @GetMapping(path="/get/Dozent/Nachname/getByID/{aID}") 
	 public String getDozentNachnameByID(@RequestParam int aID) {
		 return mDozentService.getDozentNachnameByID(aID);
		 
	 }
	 
	 @GetMapping(path="/Get/Dozent/Email/getbyID/{aID}") 
	 public String getDozentEmailByID(@RequestParam int aID) {
